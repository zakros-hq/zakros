...
- [0004 — schema-per-project Postgres isolation](docs/decisions/0004-schema-per-project-postgres-isolation.md)
- [0005 — Hecate adopts OpenBao](docs/decisions/0005-hecate-adopts-openbao-behind-vault-mcp-server.md)
- [0006 — Apollo H2a: in-process providers + 365-day service JWT (revisit H2b/K)](docs/decisions/0006-apollo-ships-in-process-providers-with-a-long-lived-service-jwt-for-h2a.md)
- [0007 — greenfield, no migration code](docs/decisions/0007-phase-2-is-greenfield-with-no-migration-code.md)
- [0008 — H2a/H2b split; Athena owns local budgets](docs/decisions/0008-slice-h2-splits-into-h2a-transparent-proxy-and-h2b-enforcement.md)
- [0009 — Argus extracted before the broker fleet](docs/decisions/0009-argus-extracts-before-the-broker-fleet-lands.md)
